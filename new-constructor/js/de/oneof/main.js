...
let parametersAllArr = {
    color: [
        ["#000000", "Schwarz", false, 0],
        ["#804E82", "Violett", false, 0],
        ["#E4CAF1", "Lavendel", false, 0],
        ["#FDD9E8", "Marshmallow", false, 0],
        ["#E5CCAE", "Sand", false, 0],
        ["#997D68", "Kaffee", false, 0],
        ["#FFFFFF", "Weiß", false, 0],
        ["#BAC1BF", "Rauchig", false, 0],
        ["#57555A", "Graphit", false, 0],
        ["#E42C36", "Rot", false, 0],
        ["#FE6203", "Halloween", false, 0],
        ["#FFE270", "Gelb", false, 0],
        ["#F2EC7A", "Zitrone", false, 0],
        ["#E33D85", "Fuchsia", false, 0],
        ["#74C86A", "Limette", false, 0],
        ["#64762C", "Khaki", false, 0],
        ["#97A38F", "Olivgrün", false, 0],
        ["#1F9480", "Smaragd", false, 0],
        ["#B3E2D8", "Tiffanyblau", false, 0],
        ["#2E4393", "Blau", false, 0],
        ["#83A3EC", "Cyan", false, 0],
        ["#BB847F", "Staubrosa", false, 0],
        ["#A2BEEE", "Staubiger Denim", false, 0],
        ["#91B4B8", "Schneemint", false, 0],
        ["#EDBFC1", "Pfirsich", false, 0],
        ["#FDAE97", "Koralle", false, 0],
        ["#E2E4E6", "Milchmelange", false, 0],
        ["#E5E4EA", "Tofu", false, 0],
    ],
    cut: [
        ["bochonok", "Übergröße", false, 0],
        ["pryamoy", "Gerade", false, 0],
        ["classic", "Klassisch", false, 0]
    ],
    length: [
        ["long", "Lang", false, 0],
        ["midi", "Mittellang", false, 0],
        ["short", "Kurz", false, 0],
        ["krop", "Kurz geschnitten", false, 0]
    ],
    bottom: [
        ["na-zatyashke-so-shnurkom", "Gummiband mit Kordel", false, 0],
        ["na-rezinke", "Gummiband", false, 0],
        ["oborka", "Volant", false, 0],
        ["obrezanniy-kray", "Gekürzt", false, 0],
        ["kashkorse", "Dekoratives geripptes Gummiband", false, 0],
        ["shirokiy-manzhet", "Breite Bündchen aus Hauptstoff", false, 0],
        ["shov", "Ohne Band", false, 0],
    ],
    bottomKrop: [
        ["na-zatyashke-so-shnurkom", "Gummiband mit Kordel", false, 0],
        ["na-rezinke", "Gummiband", false, 0],
    ...
    pocket: [
        ["pocket-no", "Keine Taschen", false, 0],
        ["kenguru", "Kangarotasche", false, 0],
        ["na-grudi", "Patchtaschen mit Klappen", false, 0],
        ["bokovie", "Seitentaschen", false, 0],
        ["taynik", "Stash-Tasche", false, 0],
    ],
    cuff: [
        ["na-rezinke", "Gummiband", false, 0],
        ["obrezanniy", "Gekürzt", false, 0],
        ["manshet-s-dirkoy", "Mit Loch im Bündchen", false, 0],
        ["kashkorse", "Dekoratives geripptes Gummiband", false, 0],
        ["shov", "Ohne Band", false, 0]
    ],
    hood: [
        ["klassika-s-verevkami", "Klassisch mit Kordel", false, 0],
        ["vnakhlest-bez-verovok", "Überlappt ohne Kordel", false, 0],
        ["anorak", "Anorak", false, 0],
        ["dvoynoy-vorotnik", "Doppeltes Kapuzen", false, 0],
        ["anorak-dvoynoy", "Doppeltes Kapuzen + Anorak", false, 0],
        ["na-molnii", "Reißverschlusskapuze", false, 0],
        ["s-molniyey-sboku", "Seitliche Reißverschlusskapuze", false, 0],
        ["vnakhlest-vorotnik", "Kapuze + Kragen", false, 0],
        ["dino", "Drachenkapuze", false, 0],
        ["rabbit", "Häschenkapuze", false, 0],
        ["fox", "Katzenkapuze", false, 0],
    ],
    fastener: [
        ["000000", "Schwarz", false, 0],
        ["FFFFFF", "Weiß", false, 0],
...
if (choiceGetJson) {
    ...
    choiceElem = {
        color: ["#997D68", "Kaffee", false, 0],
        cut: ["pryamoy", "Gerade", false, 0],
        length: ["midi", "Mittellang", false, 0],
        bottom: ["kashkorse", "Dekoratives geripptes Gummiband", false, 0],
        pocket: ["kenguru", "Kangarotasche", false, 0],
        cuff: ["kashkorse", "Dekoratives geripptes Gummiband", false, 0],
        hood: ["vnakhlest-bez-verovok", "Überlappt ohne Kordel", false, 0],
        cloth: ["no", "Ohne Noppen", false, 0],
        // embroidery: ["no", "Не выбран", false, 0],
        size: ["no", "Keine Auswahl", false, 0],
        growth: ["no", "Keine Auswahl", false, 0],
    }
}
...
async function choiceActive() {
    ...
    if (attr == "length") {
        ...
        let lengthItem,
            ...
            pocketItem;
        if (item == "krop") {
            choiceElem["pocket"] = ["pocket-no", "Keine Taschen", false, 0];
            choiceElem["bottom"] = ["shov", "Naht", false, 0];
...
async function modalAdd() {
    const promise = new Promise(async (resolve, reject) => {
        let modalName = this.dataset.modal,
            modalItem = await fetch(`https://nautz.ru/new-constructor/modal/de/oneof/_${modalName}.html`);
        modal.classList.add("active");

        if (this.dataset.modal == "form") {
            modal.classList.add("full");
            calc_total("kapuzenpulli", finalPrice)
            // закончил квиз
        ...
        if (modalItem.ok) {
            ...
            if (this.dataset.modal === "form") {
                if (typeof formFlag === "undefined") {
                    await $.getScript("https://nautz.ru/new-constructor/js/de/oneof/_form.js");
                }
                resolve(modalForm())
            }
        }
...
function calc_total(length, summa) {
        ...
        if ("yes" == window.tcart_initted) {
            ...
            window.tcart.products[0] = {
                amount: summa,
                name: 'Schneidereidienstleistungen ' + length,
                price: summa,
                quantity: 1
            };
            return
...
function closeIt() {
    ...
    window.onbeforeunload = () => {
        if (!linkClick) {
            localStorage.status = 'Tab geschlossen';
        }
    };
