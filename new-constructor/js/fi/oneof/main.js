...
let parametersAllArr = {
    color: [
        ["#000000", "Musta", false, 0],
        ["#804E82", "Violetti", false, 0],
        ["#E4CAF1", "Laventeli", false, 0],
        ["#FDD9E8", "Marshmallow", false, 0],
        ["#E5CCAE", "Sand", false, 0],
        ["#997D68", "Kahvi", false, 0],
        ["#FFFFFF", "Valkoinen", false, 0],
        ["#BAC1BF", "Smoky", false, 0],
        ["#57555A", "Graphite", false, 0],
        ["#E42C36", "Punainen", false, 0],
        ["#FE6203", "Halloween", false, 0],
        ["#FFE270", "Keltainen", false, 0],
        ...
        ["#2E4393", "Blue", false, 0],
        ["#83A3EC", "Cyan", false, 0],
        ["#BB847F", "Pölyinen ruusu", false, 0],
        ["#A2BEEE", "Dusty denim", false, 0],
        ["#91B4B8", "Lumi minttu", false, 0],
        ["#EDBFC1", "Persikka", false, 0],
        ["#FDAE97", "Koralli", false, 0],
        ["#E2E4E6", "Milk melange", false, 0],
        ["#E5E4EA", "Tofu", false, 0],
    ],
    cut: [
        ["bochonok", "Ylikokoinen", false, 0],
        ["pryamoy", "Suora", false, 0],
        ["classic", "Classic", false, 0]
    ],
    length: [
        ["long", "Pitkä", false, 0],
        ["midi", "Keskipitkä", false, 0],
        ["short", "Lyhyt", false, 0],
        ["krop", "Crop", false, 0]
    ],
    bottom: [
        ["na-zatyashke-so-shnurkom", "Elastinen nauha, jossa kiristysnauha", false, 0],
        ["na-rezinke", "Elastinen nauha", false, 0],
        ["oborka", "Röyhelö", false, 0],
        ["obrezanniy-kray", "Leikattu", false, 0],
        ["kashkorse", "Koristeellinen joustava nauha", false, 0],
        ["shirokiy-manzhet", "Leveät hihansuut pääkangasta", false, 0],
        ["shov", "Ilman nauhaa", false, 0],
    ],
    bottomKrop: [
        ["na-zatyashke-so-shnurkom", "Elastinen nauha, jossa kiristysnauha", false, 0],
        ["na-rezinke", "Elastinen nauha", false, 0],
    ...
    pocket: [
        ["pocket-no", "Ei taskuja", false, 0],
        ["kenguru", "Kengurutasku", false, 0],
        ["na-grudi", "Läpälliset taskut", false, 0],
        ["bokovie", "Sivutaskut", false, 0],
        ["taynik", "Kätkötasku", false, 0],
    ],
    cuff: [
        ["na-rezinke", "Elastinen nauha", false, 0],
        ["obrezanniy", "Leikattu", false, 0],
        ["manshet-s-dirkoy", "Reikä hihansuussa", false, 0],
        ["kashkorse", "Koristeellinen joustava nauha", false, 0],
        ["shov", "Ilman nauhaa", false, 0]
    ],
    hood: [
        ["klassika-s-verevkami", "Klassinen kiristysnauhalla", false, 0],
        ["vnakhlest-bez-verovok", "Päällekkäin ilman kiristysnauhaa", false, 0],
        ["anorak", "Anorakki", false, 0],
        ["dvoynoy-vorotnik", "Kaksinkertainen huppu", false, 0],
        ["anorak-dvoynoy", "Kaksoishuppu + anorakki", false, 0],
        ["na-molnii", "Vetoketjullinen huppu", false, 0],
        ["s-molniyey-sboku", "Sivuvetoketjullinen huppu", false, 0],
        ["vnakhlest-vorotnik", "Huppu + kaulus", false, 0],
        ["dino", "Lohikäärme huppu", false, 0],
        ["rabbit", "Pupu huppu", false, 0],
        ["fox", "Kissa huppu", false, 0],
    ],
    fastener: [
        ["000000", "Musta", false, 0],
        ["FFFFFF", "Valkoinen", false, 0],
...
if (choiceGetJson) {
    ...
    choiceElem = {
        color: ["#997D68", "Kahvi", false, 0],
        cut: ["pryamoy", "Suoraan", false, 0],
        length: ["midi", "Keskipitkä", false, 0],
        bottom: ["kashkorse", "Koristeellinen joustava kylkikaistale", false, 0],
        pocket: ["kenguru", "Kengurutasku", false, 0],
        cuff: ["kashkorse", "Koristeellinen joustava nauha", false, 0],
        hood: ["vnakhlest-bez-verovok", "Päällekkäin ilman kiristysnauhaa", false, 0],
        cloth: ["no", "ilman nokkaa", false, 0],
        // embroidery: ["no", "Не выбран", false, 0],
        size: ["no", "Ei valittu", false, 0],
        growth: ["no", "Ei valittu", false, 0],
    }
}
...
async function choiceActive() {
    ...
    if (attr == "length") {
        ...
        let lengthItem,
            ...
            pocketItem;
        if (item == "krop") {
            choiceElem["pocket"] = ["pocket-no", "Ei taskuja", false, 0];
            choiceElem["bottom"] = ["shov", "Sauma", false, 0];
...
async function modalAdd() {
    const promise = new Promise(async (resolve, reject) => {
        let modalName = this.dataset.modal,
            modalItem = await fetch(`https://nautz.ru/new-constructor/modal/fi/oneof/_${modalName}.html`);
        ...
        if (modalItem.ok) {
            ...
            if (this.dataset.modal === "form") {
                if (typeof formFlag === "undefined") {
                    await $.getScript("https://nautz.ru/new-constructor/js/fi/oneof/_form.js");
                }
                resolve(modalForm())
            }
        }
...
function calc_total(length, summa) {
        ...
        if ("yes" == window.tcart_initted) {
            ...
            window.tcart.products[0] = {
                amount: summa,
                name: 'Räätälöintipalvelut ' + length,
                price: summa,
                quantity: 1
            };
            return
...
function closeIt() {
    ...
    window.onbeforeunload = () => {
        if (!linkClick) {
            localStorage.status = 'Suljin välilehden';
        }
    };
