...
let parametersAllArr = {
    color: [
        ["#000000", "Černá", false, 0],
        ["#804E82", "Fialová", false, 0],
        ["#E4CAF1", "Levandulová", false, 0],
        ["#FDD9E8", "Marshmallow", false, 0],
        ["#E5CCAE", "Písek", false, 0],
        ["#997D68", "Káva", false, 0],
        ["#FFFFFF", "Bílá", false, 0],
        ["#BAC1BF", "Kouřová", false, 0],
        ["#57555A", "Grafitová", false, 0],
        ["#E42C36", "Červená", false, 0],
        ["#FE6203", "Halloween", false, 0],
        ["#FFE270", "Žlutá", false, 0],
        ["#F2EC7A", "Citron", false, 0],
        ["#E33D85", "Fuchsie", false, 0],
        ...
        ["#83A3EC", "Modrá", false, 0],
        ["#BB847F", "Prachová růžová", false, 0],
        ["#A2BEEE", "Prachová džínová", false, 0],
        ["#91B4B8", "Sněhová máta", false, 0],
        ["#EDBFC1", "Broskvová", false, 0],
        ["#FDAE97", "Korálová", false, 0],
        ["#E2E4E6", "Mléčná melange", false, 0],
        ["#E5E4EA", "Tofu", false, 0],
    ],
    cut: [
        ["bochonok", "Oversize", false, 0],
        ["pryamoy", "Prostá", false, 0],
        ["classic", "Klasická", false, 0]
    ],
    length: [
        ["long", "Dlouhá", false, 0],
        ["midi", "Střední délka", false, 0],
        ["short", "Krátká", false, 0],
        ["krop", "Střih", false, 0]
    ],
    bottom: [
        ["na-zatyashke-so-shnurkom", "Elastický pás s šňůrkou", false, 0],
        ["na-rezinke", "Elastický pás", false, 0],
        ["oborka", "Záležitost", false, 0],
        ["obrezanniy-kray", "Zkrácená", false, 0],
        ["kashkorse", "Dekorativní žebrovaný elastický pás", false, 0],
        ["shirokiy-manzhet", "Široké manžety ve hlavní látce", false, 0],
    ...
    pocket: [
        ["pocket-no", "Bez kapes", false, 0],
        ["kenguru", "Klokaní kapsa", false, 0],
        ["na-grudi", "Kapsy s flísky", false, 0],
        ["bokovie", "Boční kapsy", false, 0],
        ["taynik", "Kapsa na drobnosti", false, 0],
    ],
    cuff: [
        ["na-rezinke", "Elastický pás", false, 0],
        ["obrezanniy", "Zkrácená", false, 0],
        ["manshet-s-dirkoy", "S dírou v manžetě", false, 0],
        ["kashkorse", "Dekorativní žebrovaný elastický pás", false, 0],
        ["shov", "Bez pásu", false, 0]
    ],
    hood: [
        ["klassika-s-verevkami", "Klasická s šňůrkou", false, 0],
        ["vnakhlest-bez-verovok", "Překrytá bez šňůrky", false, 0],
        ["anorak", "Anorak", false, 0],
        ["dvoynoy-vorotnik", "Dvojitá kapuce", false, 0],
        ["anorak-dvoynoy", "Dvojitá kapuce + anorak", false, 0],
        ["na-molnii", "Zipper kapuce", false, 0],
        ["s-molniyey-sboku", "Boční zipová kapuce", false, 0],
        ["vnakhlest-vorotnik", "Kapuce + límec", false, 0],
        ["dino", "Drak kapuce", false, 0],
        ["rabbit", "Králičí kapuce", false, 0],
        ["fox", "Kočičí kapuce", false, 0],
    ],
    fastener: [
        ["000000", "Černá", false, 0],
        ["FFFFFF", "Bílá", false, 0],
...
if (choiceGetJson) {
    ...
    choiceElem = {
        ...
        cut: ["pryamoy", "Prostá", false, 0],
        length: ["midi", "Střední délka", false, 0],
        bottom: ["kashkorse", "Dekorativní žebrovaný elastický pás", false, 0],
        pocket: ["kenguru", "Klokaní kapsa", false, 0],
        cuff: ["kashkorse", "Dekorativní žebrovaný elastický pás", false, 0],
        hood: ["vnakhlest-bez-verovok", "Překrytá bez šňůrky", false, 0],
        cloth: ["no", "Bez vlasu", false, 0],
        // embroidery: ["no", "Не выбран", false, 0],
        size: ["no", "Není vybráno", false, 0],
        growth: ["no", "Není vybráno", false, 0],
    }
}
...
async function choiceActive() {
    ...
    if (attr == "length") {
        ...
        let lengthItem,
            ...
            pocketItem;
        if (item == "krop") {
            choiceElem["pocket"] = ["pocket-no", "Bez kapes", false, 0];
...
async function modalAdd() {
    const promise = new Promise(async (resolve, reject) => {
        let modalName = this.dataset.modal,
            modalItem = await fetch(`https://nautz.ru/new-constructor/modal/cz/oneof/_${modalName}.html`);
        modal.classList.add("active");

        if (this.dataset.modal == "form") {
            modal.classList.add("full");
            calc_total("mikina s kapucí", finalPrice)
            // закончил квиз
        ...
        if (modalItem.ok) {
            ...
            if (this.dataset.modal === "form") {
                if (typeof formFlag === "undefined") {
                    await $.getScript("https://nautz.ru/new-constructor/js/cz/oneof/_form.js");
                }
                resolve(modalForm())
            }
        }
...
function closeIt() {
    ...
    window.onbeforeunload = () => {
        if (!linkClick) {
            localStorage.status = 'Zavřel kartu';
        }
    };
