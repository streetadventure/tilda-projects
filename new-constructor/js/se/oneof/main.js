...
let parametersAllArr = {
    color: [
        ...
        ["#2E4393", "Blå", false, 0],
        ["#83A3EC", "Cyan", false, 0],
        ["#BB847F", "Dustig rosa", false, 0],
        ["#A2BEEE", "Dustig denim", false, 0],
        ["#91B4B8", "Snömint", false, 0],
        ["#EDBFC1", "Persika", false, 0],
        ["#FDAE97", "Korall", false, 0],
        ["#E2E4E6", "Mjölk melange", false, 0],
        ["#E5E4EA", "Tofu", false, 0],
    ],
    cut: [
    ...
    length: [
        ["long", "Lång", false, 0],
        ["midi", "Mellanlång", false, 0],
        ["short", "Kort", false, 0],
        ["krop", "Crop", false, 0]
    ],
    bottom: [
        ["na-zatyashke-so-shnurkom", "Elastisk band med dragsko", false, 0],
        ["na-rezinke", "Elastisk band", false, 0],
        ["oborka", "Frans", false, 0],
        ["obrezanniy-kray", "cropad", false, 0],
        ["kashkorse", "Dekorativ ribbad elastisk band", false, 0],
        ["shirokiy-manzhet", "Vida manschetter i huvudtyget", false, 0],
        ["shov", "Utan band", false, 0],
    ],
    bottomKrop: [
        ["na-zatyashke-so-shnurkom", "elastisk band med dragsko", false, 0],
        ["na-rezinke", "elastisk band", false, 0],
    ...
    pocket: [
        ["pocket-no", "Inga fickor", false, 0],
        ["kenguru", "Känguruficka", false, 0],
        ["na-grudi", "Lappfickor med flikar", false, 0],
        ["bokovie", "Sidofickor", false, 0],
        ["taynik", "Förvaringsficka", false, 0],
    ],
    cuff: [
        ["na-rezinke", "Elastisk band", false, 0],
        ["obrezanniy", "Cropad", false, 0],
        ["manshet-s-dirkoy", "Med ett hål i manschetten", false, 0],
        ["kashkorse", "Dekorativ ribbad elastisk band", false, 0],
        ["shov", "Utan band", false, 0]
    ],
    hood: [
        ["klassika-s-verevkami", "Klassisk med dragsko", false, 0],
        ["vnakhlest-bez-verovok", "Överlappad utan dragsko", false, 0],
        ["anorak", "Anorak", false, 0],
        ["dvoynoy-vorotnik", "Dubbel huva", false, 0],
        ["anorak-dvoynoy", "Dubbel huva + anorak", false, 0],
        ["na-molnii", "Dragkedjahuva", false, 0],
        ["s-molniyey-sboku", "Sidodragkedjahuva", false, 0],
        ["vnakhlest-vorotnik", "Huva + krage", false, 0],
        ["dino", "Drakhuva", false, 0],
        ["rabbit", "Kaninhuva", false, 0],
        ["fox", "Katt huva", false, 0],
    ],
    fastener: [
        ["000000", "Svart", false, 0],
        ["FFFFFF", "Vitt", false, 0],
...
if (choiceGetJson) {
    ...
    choiceElem = {
        ...
        cut: ["pryamoy", "Rak", false, 0],
        length: ["midi", "Mellanlång", false, 0],
        bottom: ["kashkorse", "Dekorativ ribbad elastisk band", false, 0],
        pocket: ["kenguru", "Känguruficka", false, 0],
        cuff: ["kashkorse", "Dekorativ ribbad elastisk band", false, 0],
        hood: ["vnakhlest-bez-verovok", "Överlappad utan dragsko", false, 0],
        cloth: ["no", "utan velour", false, 0],
        // embroidery: ["no", "Не выбран", false, 0],
        size: ["no", "Inget valt", false, 0],
        growth: ["no", "Inget valt", false, 0],
    }
}
...
async function choiceActive() {
    ...
    if (attr == "length") {
        ...
        let lengthItem,
            ...
            pocketItem;
        if (item == "krop") {
            choiceElem["pocket"] = ["pocket-no", "Inga fickor", false, 0];
            choiceElem["bottom"] = ["shov", "Söm", false, 0];
...
async function modalAdd() {
    const promise = new Promise(async (resolve, reject) => {
        let modalName = this.dataset.modal,
            modalItem = await fetch(`https://nautz.ru/new-constructor/modal/se/oneof/_${modalName}.html`);
        modal.classList.add("active");

        if (this.dataset.modal == "form") {
            modal.classList.add("full");
            calc_total("tröja med huva", finalPrice)
            // закончил квиз
        ...
        if (modalItem.ok) {
            ...
            if (this.dataset.modal === "form") {
                if (typeof formFlag === "undefined") {
                    await $.getScript("https://nautz.ru/new-constructor/js/se/oneof/_form.js");
                }
                resolve(modalForm())
            }
        }
...
function calc_total(length, summa) {
        ...
        if ("yes" == window.tcart_initted) {
            ...
            window.tcart.products[0] = {
                amount: summa,
                name: 'Sömförmedlingstjänster ' + length,
                price: summa,
                quantity: 1
            };
            return
...
function closeIt() {
    ...
    window.onbeforeunload = () => {
        if (!linkClick) {
            localStorage.status = 'Stängde fliken';
        }
    };
