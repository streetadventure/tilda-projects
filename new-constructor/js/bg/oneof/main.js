...
let parametersAllArr = {
    color: [
        ["#000000", "Черно", false, 0],
        ["#804E82", "Виолетово", false, 0],
        ["#E4CAF1", "Лавандула", false, 0],
        ["#FDD9E8", "Маршмелоу", false, 0],
        ["#E5CCAE", "Пясък", false, 0],
        ["#997D68", "Кафе", false, 0],
        ["#FFFFFF", "Бяло", false, 0],
        ["#BAC1BF", "Опушен", false, 0],
        ["#57555A", "Графит", false, 0],
        ["#E42C36", "Червено", false, 0],
        ["#FE6203", "Хелоуин", false, 0],
        ["#FFE270", "Жълто", false, 0],
        ["#F2EC7A", "Лимон", false, 0],
        ["#E33D85", "Фуксия", false, 0],
        ["#74C86A", "Лайм", false, 0],
        ["#64762C", "Хаки", false, 0],
        ["#97A38F", "Маслина", false, 0],
        ["#1F9480", "Изумруд", false, 0],
        ["#B3E2D8", "Тифани", false, 0],
        ["#2E4393", "Синьо", false, 0],
        ["#83A3EC", "Цианово", false, 0],
        ["#BB847F", "Прашна роза", false, 0],
        ["#A2BEEE", "Прашен деним", false, 0],
        ["#91B4B8", "Снежна мента", false, 0],
        ["#EDBFC1", "Праскова", false, 0],
        ["#FDAE97", "Корал", false, 0],
        ["#E2E4E6", "Млечен меланж", false, 0],
        ["#E5E4EA", "Тофу", false, 0],
    ],
    cut: [
        ["bochonok", "Овърсайз", false, 0],
        ["pryamoy", "Прав", false, 0],
        ["classic", "Класически", false, 0]
    ],
    length: [
        ["long", "Дълъг", false, 0],
        ["midi", "Средна дължина", false, 0],
        ["short", "Къса", false, 0],
        ["krop", "Crop", false, 0]
    ],
    bottom: [
        ["na-zatyashke-so-shnurkom", "Еластична лента с шнур за пристягане", false, 0],
        ["na-rezinke", "Еластична лента", false, 0],
        ["oborka", "Ресни", false, 0],
        ["obrezanniy-kray", "Изрязан", false, 0],
        ["kashkorse", "Декоративен оребрен ластик", false, 0],
        ["shirokiy-manzhet", "Широки маншети от основен плат", false, 0],
        ["shov", "Без ластик", false, 0],
    ],
    bottomKrop: [
        ["na-zatyashke-so-shnurkom", "Еластична лента с шнур за пристягане", false, 0],
        ["na-rezinke", "Еластична лента", false, 0],
        ["obrezanniy-kray", "Изрязан", false, 0],
        ["shov", "Без лента", false, 0],
    ],
    pocket: [
        ["pocket-no", "Без джобове", false, 0],
        ["kenguru", "Кенгуру джоб", false, 0],
        ["na-grudi", "Напластени джобове с капаци", false, 0],
        ["bokovie", "Странични джобове", false, 0],
        ["taynik", "джоб за скривалище", false, 0],
    ],
    cuff: [
        ["na-rezinke", "Еластична лента", false, 0],
        ["obrezanniy", "Изрязан", false, 0],
        ["manshet-s-dirkoy", "С дупка на маншета", false, 0],
        ["kashkorse", "Декоративен оребрен ластик", false, 0],
        ["shov", "Без ластик", false, 0]
    ],
    hood: [
        ["klassika-s-verevkami", "Класически с шнур за пристягане", false, 0],
        ["vnakhlest-bez-verovok", "С припокриване без шнур", false, 0],
        ["anorak", "Анорак", false, 0],
        ["dvoynoy-vorotnik", "Двойна качулка", false, 0],
        ["anorak-dvoynoy", "Двойна качулка + анорак", false, 0],
        ["na-molnii", "Качулка с цип", false, 0],
        ["s-molniyey-sboku", "Странична качулка с цип", false, 0],
        ["vnakhlest-vorotnik", "Качулка + яка", false, 0],
        ["dino", "Качулка дракон", false, 0],
        ["rabbit", "Качулка със зайче", false, 0],
        ["fox", "Котешка качулка", false, 0],
    ],
    fastener: [
        ["000000", "Черно", false, 0],
        ["FFFFFF", "Бял", false, 0],
...
if (choiceGetJson) {
    ...
    choiceElem = {
        color: ["#997D68", "Кафе", false, 0],
        cut: ["pryamoy", "Направо", false, 0],
        length: ["midi", "Средна дължина", false, 0],
        bottom: ["kashkorse", "Декоративен оребрен ластик", false, 0],
        pocket: ["kenguru", "Кенгуру джоб", false, 0],
        cuff: ["kashkorse", "Декоративен оребрен ластик", false, 0],
        hood: ["vnakhlest-bez-verovok", "Застъпване без шнур за пристягане", false, 0],
        cloth: ["no", "без дюшек", false, 0],
        // embroidery: ["no", "Не выбран", false, 0],
        size: ["no", "Без избран", false, 0],
        growth: ["no", "Не е избран", false, 0],
    }
}
...
async function choiceActive() {
    ...
    if (attr == "length") {
        ...
        let lengthItem,
            ...
            pocketItem;
        if (item == "krop") {
            choiceElem["pocket"] = ["pocket-no", "Без джобове", false, 0];
            choiceElem["bottom"] = ["shov", "Шев", false, 0];
...
async function modalAdd() {
    const promise = new Promise(async (resolve, reject) => {
        let modalName = this.dataset.modal,
            modalItem = await fetch(`https://nautz.ru/new-constructor/modal/bg/oneof/_${modalName}.html`);
        ...
        if (modalItem.ok) {
            ...
            if (this.dataset.modal === "form") {
                if (typeof formFlag === "undefined") {
                    await $.getScript("https://nautz.ru/new-constructor/js/bg/oneof/_form.js");
                }
                resolve(modalForm())
            }
        }
...
function closeIt() {
    ...
    window.onbeforeunload = () => {
        if (!linkClick) {
            localStorage.status = 'Затваряне на раздела';
        }
    };
