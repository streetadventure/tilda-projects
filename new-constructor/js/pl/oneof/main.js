...
let parametersAllArr = {
    color: [
        ["#000000", "Czarny", false, 0],
        ["#804E82", "Fioletowy", false, 0],
        ["#E4CAF1", "Lawenda", false, 0],
        ["#FDD9E8", "Marshmallow", false, 0],
        ["#E5CCAE", "Piasek", false, 0],
        ["#997D68", "Kawa", false, 0],
        ["#FFFFFF", "Biały", false, 0],
        ["#BAC1BF", "Dymny", false, 0],
        ["#57555A", "Grafitowy", false, 0],
        ["#E42C36", "Czerwony", false, 0],
        ["#FE6203", "Halloween", false, 0],
        ["#FFE270", "Żółty", false, 0],
        ["#F2EC7A", "Cytrynowy", false, 0],
        ["#E33D85", "Fuksja", false, 0],
        ["#74C86A", "Lime", false, 0],
        ["#64762C", "Khaki", false, 0],
        ["#97A38F", "Oliwkowy", false, 0],
        ["#1F9480", "Szmaragd", false, 0],
        ["#B3E2D8", "Tiffany", false, 0],
        ["#2E4393", "Niebieski", false, 0],
        ["#83A3EC", "Cyjan", false, 0],
        ["#BB847F", "Pyłowa róża", false, 0],
        ["#A2BEEE", "Kurzy dżins", false, 0],
        ["#91B4B8", "Śnieżna mięta", false, 0],
        ["#EDBFC1", "Brzoskwinia", false, 0],
        ["#FDAE97", "Koral", false, 0],
        ["#E2E4E6", "Mleczny melanż", false, 0],
        ["#E5E4EA", "Tofu", false, 0],
    ],
    cut: [
        ["bochonok", "Oversize", false, 0],
        ["pryamoy", "Prosto", false, 0],
        ["classic", "Klasyczny", false, 0]
    ],
    length: [
        ["long", "Długie", false, 0],
        ["midi", "Średniej długości", false, 0],
        ["short", "Krótkie", false, 0],
        ["krop", "Crop", false, 0]
    ],
    bottom: [
        ["na-zatyashke-so-shnurkom", "Elastyczna taśma z paskiem do ściągania", false, 0],
        ["na-rezinke", "Elastyczna taśma", false, 0],
        ["oborka", "Falbanka", false, 0],
        ["obrezanniy-kray", "Cropped", false, 0],
        ["kashkorse", "Ozdobna gumka w pasie", false, 0],
        ["shirokiy-manzhet", "Szerokie mankiety z głównego materiału", false, 0],
        ["shov", "Bez taśmy", false, 0],
    ],
    bottomKrop: [
        ["na-zatyashke-so-shnurkom", "Elastyczna taśma ze sznurkiem do ściągania", false, 0],
        ["na-rezinke", "Elastyczna taśma", false, 0],
        ["obrezanniy-kray", "Przycięty", false, 0],
        ["shov", "Bez taśmy", false, 0],
    ],
    pocket: [
        ["pocket-no", "Bez kieszeni", false, 0],
        ["kenguru", "Kieszeń kangurowa", false, 0],
        ["na-grudi", "Naszywane kieszenie z klapkami", false, 0],
        ["bokovie", "Kieszenie boczne", false, 0],
        ["taynik", "Kieszeń na schowek", false, 0],
    ],
    cuff: [
        ["na-rezinke", "Elastyczna taśma", false, 0],
        ["obrezanniy", "Cropped", false, 0],
        ["manshet-s-dirkoy", "Z dziurą w mankiecie", false, 0],
        ["kashkorse", "Ozdobna, prążkowana gumka", false, 0],
        ["shov", "Bez taśmy", false, 0]
    ],
    hood: [
        ["klassika-s-verevkami", "Klasyczny z taśmą ściągającą", false, 0],
        ["vnakhlest-bez-verovok", "Zakładany bez sznurka ściągającego", false, 0],
        ["anorak", "Anorak", false, 0],
        ["dvoynoy-vorotnik", "Podwójny kaptur", false, 0],
        ["anorak-dvoynoy", "Podwójny kaptur + anorak", false, 0],
        ["na-molnii", "Kaptur z zamkiem błyskawicznym", false, 0],
        ["s-molniyey-sboku", "Kaptur z bocznym zamkiem błyskawicznym", false, 0],
        ["vnakhlest-vorotnik", "Kaptur + stójka", false, 0],
        ["dino", "Kaptur w kształcie smoka", false, 0],
        ["rabbit", "Kaptur królika", false, 0],
        ["fox", "Kaptur z kotem", false, 0],
    ],
    fastener: [
        ["000000", "Czarny", false, 0],
        ["FFFFFF", "Biały", false, 0],
...
if (choiceGetJson) {
    ...
    choiceElem = {
        color: ["#997D68", "Kawa", false, 0],
        cut: ["pryamoy", "Proste", false, 0],
        length: ["midi", "Średnia długość", false, 0],
        bottom: ["kashkorse", "Ozdobny prążkowany pasek elastyczny", false, 0],
        pocket: ["kenguru", "Kieszeń kangurka", false, 0],
        cuff: ["kashkorse", "Ozdobna gumka w pasie", false, 0],
        hood: ["vnakhlest-bez-verovok", "Zakładka bez sznurka do ściągania", false, 0],
        cloth: ["no", "bez nap", false, 0],
        // embroidery: ["no", "Не выбран", false, 0],
        size: ["no", "Niewybrany", false, 0],
        growth: ["no", "Niewybrany", false, 0],
    }
}
...
async function choiceActive() {
    ...
    if (attr == "length") {
        ...
        let lengthItem,
            ...
            pocketItem;
        if (item == "krop") {
            choiceElem["pocket"] = ["pocket-no", "Brak kieszeni", false, 0];
            choiceElem["bottom"] = ["shov", "Szwy", false, 0];
...
async function modalAdd() {
    const promise = new Promise(async (resolve, reject) => {
        let modalName = this.dataset.modal,
            modalItem = await fetch(`https://nautz.ru/new-constructor/modal/pl/oneof/_${modalName}.html`);
        modal.classList.add("active");

        if (this.dataset.modal == "form") {
            modal.classList.add("full");
            calc_total("Bluza z kapturem", finalPrice)
            // закончил квиз
        ...
        if (modalItem.ok) {
            ...
            if (this.dataset.modal === "form") {
                if (typeof formFlag === "undefined") {
                    await $.getScript("https://nautz.ru/new-constructor/js/pl/oneof/_form.js");
                }
                resolve(modalForm())
            }
        }
...
function closeIt() {
    ...
    window.onbeforeunload = () => {
        if (!linkClick) {
            localStorage.status = 'Zamknięta zakładka';
        }
    };
