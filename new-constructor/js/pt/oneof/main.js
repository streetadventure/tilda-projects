...
let parametersAllArr = {
    color: [
        ["#000000", "Preto", false, 0],
        ["#804E82", "Violeta", false, 0],
        ["#E4CAF1", "Alfazema", false, 0],
        ["#FDD9E8", "Marshmallow", false, 0],
        ["#E5CCAE", "Areia", false, 0],
        ["#997D68", "Café", false, 0],
        ["#FFFFFF", "Branco", false, 0],
        ["#BAC1BF", "Smoky", false, 0],
        ["#57555A", "Grafite", false, 0],
        ["#E42C36", "Vermelho", false, 0],
        ["#FE6203", "Halloween", false, 0],
        ["#FFE270", "Amarelo", false, 0],
        ["#F2EC7A", "Limão", false, 0],
        ["#E33D85", "Fuchsia", false, 0],
        ["#74C86A", "Tília", false, 0],
        ["#64762C", "Khaki", false, 0],
        ["#97A38F", "Azeitona", false, 0],
        ["#1F9480", "Esmeralda", false, 0],
        ["#B3E2D8", "Tiffany", false, 0],
        ["#2E4393", "Azul", false, 0],
        ["#83A3EC", "Ciano", false, 0],
        ["#BB847F", "Rosa empoeirada", false, 0],
        ["#A2BEEE", "Ganga empoeirada", false, 0],
        ["#91B4B8", "Hortelã da neve", false, 0],
        ["#EDBFC1", "Pêssego", false, 0],
        ["#FDAE97", "Coral", false, 0],
        ["#E2E4E6", "Mistura de leite", false, 0],
        ["#E5E4EA", "Tofu", false, 0],
    ],
    cut: [
        ["bochonok", "Oversize", false, 0],
        ["pryamoy", "Em linha recta", false, 0],
        ["classic", "Clássico", false, 0]
    ],
    length: [
        ["long", "Longo", false, 0],
        ["midi", "Comprimento médio", false, 0],
        ["short", "Curta", false, 0],
        ["krop", "Culturas", false, 0]
    ],
    bottom: [
        ["na-zatyashke-so-shnurkom", "Faixa elástica com cordão de cordão", false, 0],
        ["na-rezinke", "Faixa elástica", false, 0],
        ["oborka", "Frill", false, 0],
        ["obrezanniy-kray", "Cortado", false, 0],
        ["kashkorse", "Faixa elástica decorativa com nervuras", false, 0],
        ["shirokiy-manzhet", "Algemas largas no tecido principal", false, 0],
        ["shov", "Sem banda", false, 0],
    ],
    bottomKrop: [
        ["na-zatyashke-so-shnurkom", "Faixa elástica com cordão de cordão", false, 0],
        ["na-rezinke", "Faixa elástica", false, 0],
    ...
    pocket: [
        ["pocket-no", "Sem bolsos", false, 0],
        ["kenguru", "Bolso canguru", false, 0],
        ["na-grudi", "Bolsos de remendos com abas", false, 0],
        ["bokovie", "Bolsos laterais", false, 0],
        ["taynik", "Bolso da caixinha", false, 0],
    ],
    cuff: [
        ["na-rezinke", "Faixa elástica", false, 0],
        ["obrezanniy", "Cortado", false, 0],
        ["manshet-s-dirkoy", "Com um buraco no punho", false, 0],
        ["kashkorse", "Faixa elástica decorativa com nervuras", false, 0],
        ["shov", "Sem banda", false, 0]
    ],
    hood: [
        ["klassika-s-verevkami", "Clássico com cordão de cordão", false, 0],
        ["vnakhlest-bez-verovok", "Sobreposto sem cordão de tracção", false, 0],
        ["anorak", "Anorak", false, 0],
        ["dvoynoy-vorotnik", "Capuz duplo", false, 0],
        ["anorak-dvoynoy", "Capuz duplo + anorak", false, 0],
        ["na-molnii", "Capuz de zíper", false, 0],
        ["s-molniyey-sboku", "Capuz lateral do fecho de correr", false, 0],
        ["vnakhlest-vorotnik", "Capuz + colarinho", false, 0],
        ["dino", "Capuz do dragão", false, 0],
        ["rabbit", "Capuz de coelhinho", false, 0],
        ["fox", "Capuz de gato", false, 0],
    ],
    fastener: [
        ["000000", "Preto", false, 0],
        ["FFFFFF", "Branco", false, 0],
...
if (choiceGetJson) {
    ...
    choiceElem = {
        ...
        cut: ["pryamoy", "Em linha recta", false, 0],
        length: ["midi", "Comprimento médio", false, 0],
        bottom: ["kashkorse", "Faixa elástica decorativa com nervuras", false, 0],
        pocket: ["kenguru", "Bolso canguru", false, 0],
        cuff: ["kashkorse", "Faixa elástica decorativa com nervuras", false, 0],
        hood: ["vnakhlest-bez-verovok", "Sobreposto sem cordão de tracção", false, 0],
        cloth: ["no", "Sem cochilo", false, 0],
        // embroidery: ["no", "Не выбран", false, 0],
        size: ["no", "Não seleccionado", false, 0],
        growth: ["no", "Não seleccionado", false, 0],
    }
}
...
async function choiceActive() {
    ...
    if (attr == "length") {
        ...
        let lengthItem,
            ...
            pocketItem;
        if (item == "krop") {
            choiceElem["pocket"] = ["pocket-no", "Sem bolsos", false, 0];
...
async function modalAdd() {
    const promise = new Promise(async (resolve, reject) => {
        let modalName = this.dataset.modal,
            modalItem = await fetch(`https://nautz.ru/new-constructor/modal/pt/oneof/_${modalName}.html`);
        modal.classList.add("active");

        if (this.dataset.modal == "form") {
            modal.classList.add("full");
            calc_total("camisola com capuz", finalPrice)
            // закончил квиз
        ...
        if (modalItem.ok) {
            ...
            if (this.dataset.modal === "form") {
                if (typeof formFlag === "undefined") {
                    await $.getScript("https://nautz.ru/new-constructor/js/pt/oneof/_form.js");
                }
                resolve(modalForm())
            }
        }
...
function calc_total(length, summa) {
        ...
        if ("yes" == window.tcart_initted) {
            ...
            window.tcart.products[0] = {
                amount: summa,
                name: 'Serviços de alfaiataria ' + length,
                price: summa,
                quantity: 1
            };
            return
...
function closeIt() {
    ...
    window.onbeforeunload = () => {
        if (!linkClick) {
            localStorage.status = 'Fechou a aba';
        }
    };
