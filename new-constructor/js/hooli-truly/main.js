        ...
        if (modalItem.ok) {
            ...
            if (this.dataset.modal === "form") {
                if (typeof formFlag === "undefined") {
                    ym(92187423,'reachGoal','hoodie_ready')
                    await $.getScript("https://nautz.ru/new-constructor/js/hooli-truly/_form.js");
                }
                resolve(modalForm())
            }
        }
...
if (pv == 0) {
    ...
    if (typeof (window.ym) != "undefined") {
        ym(92187423,'reachGoal','start_quiz')
    }
    pv++
}
// начал оплату
$('.constructor-hoodie').on('click', '#formnewconstructor button', function (e) {
    ...
    if (typeof (window.ym) != "undefined") {
        ym(92187423,'reachGoal','payment_start');
    }
