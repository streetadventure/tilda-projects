...
let parametersAllArr = {
    color: [
        ...
        ["#FFFFFF", "Hvit", false, 0],
        ["#BAC1BF", "Røyk", false, 0],
        ["#57555A", "Grafitt", false, 0],
        ["#E42C36", "Rød", false, 0],
        ["#FE6203", "Halloween", false, 0],
        ["#FFE270", "Gul", false, 0],
        ["#F2EC7A", "Sitron", false, 0],
        ...
        ["#2E4393", "Blå", false, 0],
        ["#83A3EC", "Cyan", false, 0],
        ["#BB847F", "Støvet rosa", false, 0],
        ["#A2BEEE", "Støvet denim", false, 0],
        ["#91B4B8", "Snømynte", false, 0],
        ["#EDBFC1", "Fersken", false, 0],
        ["#FDAE97", "Korall", false, 0],
        ["#E2E4E6", "Melk melange", false, 0],
        ["#E5E4EA", "Tofu", false, 0],
    ],
    cut: [
        ["bochonok", "Oversize", false, 0],
        ["pryamoy", "Rett", false, 0],
        ["classic", "Klassisk", false, 0]
    ],
    length: [
        ["long", "Lang", false, 0],
        ["midi", "Mellomlang", false, 0],
        ["short", "Kort", false, 0],
        ["krop", "Avklipt", false, 0]
    ],
    bottom: [
        ["na-zatyashke-so-shnurkom", "Elastisk bånd med snor", false, 0],
        ["na-rezinke", "Elastisk bånd", false, 0],
        ["oborka", "Volanger", false, 0],
        ["obrezanniy-kray", "Avklipt", false, 0],
        ["kashkorse", "Dekorativ ribbet elastisk bånd", false, 0],
        ["shirokiy-manzhet", "Vide mansjetter i hovedstoffet", false, 0],
        ["shov", "Uten bånd", false, 0],
    ],
    bottomKrop: [
        ["na-zatyashke-so-shnurkom", "Elastisk bånd med snor", false, 0],
        ["na-rezinke", "Elastisk bånd", false, 0],
    ...
    pocket: [
        ...
        ["kenguru", "Kenguru-lomme", false, 0],
        ["na-grudi", "Patch-lommer med flapper", false, 0],
        ["bokovie", "Sidelommer", false, 0],
        ["taynik", "Skjult lomme", false, 0],
    ],
    cuff: [
        ["na-rezinke", "Elastisk bånd", false, 0],
        ["obrezanniy", "Avklipt", false, 0],
        ["manshet-s-dirkoy", "Med et hull i mansjetten", false, 0],
        ["kashkorse", "Dekorativ ribbet elastisk bånd", false, 0],
        ["shov", "Uten bånd", false, 0]
    ],
    hood: [
        ["klassika-s-verevkami", "Klassisk med snor", false, 0],
        ["vnakhlest-bez-verovok", "Overlappet uten snor", false, 0],
        ["anorak", "Anorakk", false, 0],
        ["dvoynoy-vorotnik", "Dobbelt hette", false, 0],
        ["anorak-dvoynoy", "Dobbelt hette + anorakk", false, 0],
        ["na-molnii", "Glidelås-hette", false, 0],
        ["s-molniyey-sboku", "Sidesykkelhette", false, 0],
        ["vnakhlest-vorotnik", "Hette + krage", false, 0],
        ["dino", "Dragehette", false, 0],
        ["rabbit", "Kaninhette", false, 0],
        ["fox", "Katt hette", false, 0],
    ],
    fastener: [
        ["000000", "Svart", false, 0],
        ["FFFFFF", "Hvit", false, 0],
...
if (choiceGetJson) {
    ...
    choiceElem = {
        ...
        cut: ["pryamoy", "Rett", false, 0],
        length: ["midi", "Mellomlang", false, 0],
        bottom: ["kashkorse", "Dekorativ ribbet elastisk bånd", false, 0],
        pocket: ["kenguru", "Kenguru-lomme", false, 0],
        cuff: ["kashkorse", "Dekorativ ribbet elastisk bånd", false, 0],
        hood: ["vnakhlest-bez-verovok", "Overlappet uten snor", false, 0],
        cloth: ["no", "Uten fôr", false, 0],
        // embroidery: ["no", "Не выбран", false, 0],
        size: ["no", "Ingen valgt", false, 0],
        growth: ["no", "Ingen valgt", false, 0],
    }
}
...
async function modalAdd() {
    const promise = new Promise(async (resolve, reject) => {
        let modalName = this.dataset.modal,
            modalItem = await fetch(`https://nautz.ru/new-constructor/modal/no/oneof/_${modalName}.html`);
        modal.classList.add("active");

        if (this.dataset.modal == "form") {
            modal.classList.add("full");
            calc_total("hettegenser", finalPrice)
            // закончил квиз
        ...
        if (modalItem.ok) {
            ...
            if (this.dataset.modal === "form") {
                if (typeof formFlag === "undefined") {
                    await $.getScript("https://nautz.ru/new-constructor/js/no/oneof/_form.js");
                }
                resolve(modalForm())
            }
        }
...
function closeIt() {
    ...
    window.onbeforeunload = () => {
        if (!linkClick) {
            localStorage.status = 'Lukket fanen';
        }
    };
