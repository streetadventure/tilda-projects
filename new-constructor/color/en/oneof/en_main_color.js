...
let parametersAllArr = {
    color: [
        ["#000000", "Black", true, 0],
        ["#804E82", "Violet", true, 0],
        ["#E4CAF1", "Lavender", true, 0],
        ["#FDD9E8", "Marshmallow", true, 0],
        ["#E5CCAE", "Sand", true, 0],
        ["#997D68", "Coffee", true, 0],
        ["#FFFFFF", "White", true, 0],
        ["#BAC1BF", "Smoky", true, 0],
        ["#57555A", "Graphite", true, 0],
        ["#E42C36", "Red", true, 0],
        ["#FE6203", "Halloween", true, 0],
        ["#FFE270", "Yellow", true, 0],
        ["#F2EC7A", "Lemon", true, 0],
        ["#E33D85", "Fuchsia", true, 0],
        ["#74C86A", "Lime", true, 0],
        ["#64762C", "Khaki", true, 0],
        ["#97A38F", "Olive", true, 0],
        ["#1F9480", "Emerald", true, 0],
        ["#B3E2D8", "Tiffany", true, 0],
        ["#2E4393", "Blue", true, 0],
        ["#83A3EC", "Cyan", true, 0],
        ["#BB847F", "Dusty rose", true, 0],
        ["#A2BEEE", "Dusty denim", true, 0],
        ["#91B4B8", "Snow mint", true, 0],
        ["#EDBFC1", "Peach", true, 0],
        ["#FDAE97", "Coral", true, 0],
        ["#E2E4E6", "Milk melange", true, 0],
        ["#E5E4EA", "Tofu", true, 0],
    ]
};
...
if (choiceGetJson) {
    ...
    choiceElem = {
        "sleeve-left": ["#997D68", "Coffee", false, 0],
        "sleeve-right": ["#997D68", "Coffee", false, 0],
        "cuff-right": ["#997D68", "Coffee", false, 0],
        "cuff-left": ["#997D68", "Coffee", false, 0],
        front: ["#997D68", "Coffee", false, 0],
        back: ["#997D68", "Coffee", false, 0],
        hood: ["#997D68", "Coffee", false, 0],
        pocket: ["#997D68", "Coffee", false, 0],
        bottom: ["#997D68", "Coffee", false, 0],
        cloth: ["no", "without nap", false, 0],
        // embroidery: ["no", "Не выбран", false, 0],
        size: ["no", "Not selected", false, 0],
        growth: ["no", "Not selected", false, 0],
    }
}
...
async function choiceActive(param = false) {
    ...
    //Рост
    if (attr == "growth") {
        choiceElem[attr] = [item, item + "cm", true, price];
